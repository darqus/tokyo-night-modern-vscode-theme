...
describe('UI Generator Tests', () => {
  ...
  describe('Input Colors', () => {
    it('should generate input colors', () => {
      ...
      expect(colors['inputValidation.infoForeground']).toBeDefined()
      expect(colors['inputValidation.infoBackground']).toBeDefined()
      expect(colors['inputValidation.infoBorder']).toBeDefined()
      expect(colors['inputValidation.warningForeground']).toBeDefined()
      expect(colors['inputValidation.warningBackground']).toBeDefined()
      expect(colors['inputValidation.warningBorder']).toBeDefined()
      expect(colors['inputValidation.errorForeground']).toBeDefined()
      expect(colors['inputValidation.errorBackground']).toBeDefined()
      expect(colors['inputValidation.errorBorder']).toBeDefined()
