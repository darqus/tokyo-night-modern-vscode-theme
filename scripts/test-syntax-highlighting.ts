...
const _objectValue: { name: string; age: number } = { name: 'Иван', age: 30 }

// Функции
function _simpleFunction(): void {
...
// Асинхронные функции
async function _asyncFunction(): Promise<string> {
...
const _result = arrowFunction('параметр')
const _genericResult = genericFunction<number>(123)
const _enumValue = TestEnum.First
