...
export const palette: Palette = {
  bg: {
    ...
    elevated: '#1a1b26', // Приподнятые элементы (панели, диалоги) - осветлен для лучшей видимости подсказок
    sunken: '#14141c', // Утопленные области (статусбар, некоторые панели) - затемнен
    overlay: '#1c1d28', // Оверлеи и модальные окна - осветлен для уведомлений
