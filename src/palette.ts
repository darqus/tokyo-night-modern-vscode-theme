...
export const palette: Palette = {
  bg: {
    ...
    hover: '#1f2029', // Состояние наведения для интерактивных элементов - более приглушённый холодный тон
    active: '#22232e', // Активные/нажатые элементы - используем цвет границ для консистентности
