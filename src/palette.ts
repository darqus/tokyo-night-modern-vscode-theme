...
export const palette: Palette = {
  ...
  brand: {
    // Брендовые цвета
    primary: '#7dcfff', // Более темный брендовый цвет (кнопки, ссылки) - было #7dcfff
    button: {
      // Специфичные цвета кнопок
      primary: '#263147', // Более темный фон основной кнопки - было #3d59a1
      hover: '#40537a', // Более темный фон кнопки при наведении - было #4c6cb3
    },
  },
  accent: {
  ...
  ui: {
    ...
    list: {
      // Списки
      hoverBg: '#2a3047', // Улучшенный фон списка при наведении
    ...
    statusItem: {
      ...
      hover: '#2a3047', // Улучшенное наведение на элемент статусбара
