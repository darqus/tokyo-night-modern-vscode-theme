...
export const palette: Palette = {
  bg: {
    ...
    base: '#18181d', // Основной фон редактора и боковых панелей
    elevated: '#1c1d24', // Приподнятые элементы (панели, диалоги)
    sunken: '#16161b', // Утопленные области (статусбар, некоторые панели)
    overlay: '#1e1f26', // Оверлеи и модальные окна
    input: '#1a1a21', // Поля ввода и формы
    hover: '#242530', // Состояние наведения для интерактивных элементов - более приглушённый холодный тон
    active: '#26293a', // Активные/нажатые элементы - используем цвет границ для консистентности
    drop: '#2b3140', // Зоны перетаскивания для drag&drop
    lineHighlight: '#1c1d24', // Подсветка текущей строки
    bracketMatch: '#202129', // Подсветка соответствующих скобок
    tabs: '#18181d', // Фон вкладок
    selection: {
  ...
  line: {
    // Линии и границы
    border: '#262733', // Основные границы элементов
    menu: '#262733', // Границы в меню
  },
  fg: {
    ...
    subtle: '#7580a7', // Тонкий текст (подсказки, метки) - увеличена яркость для WCAG AA (4.5:1)
  ...
  accent: {
    ...
    yellow: '#7dd3fc', // Холодный голубо-желтый - числа, параметры
    orange: '#6366f1', // Холодный индиго - функции, методы
  ...
  token: {
    ...
    constant: '#7dd3fc', // Константные значения (числа, булевы) - холодный голубо-желтый
    ...
    templateKeyword: '#73daca', // Ключевые слова Blade/Twig/Smarty
    spread: '#e0687a', // Оператор распространения
    operator: '#a9b1d6', // Операторы и пунктуация
    importExport: '#bb9af7', // Ключевые слова import/export
    ...
    tagPunctuation: '#a9b1d6', // Пунктуация тегов
    globalConstant: '#7dd3fc', // Глобальные константы - холодный голубо-желтый
    ...
    functionArg: '#38bdf8', // Аргументы функций - холодный голубой
    ...
    cssValue: '#34d399', // CSS значения - холодный зеленый
    ...
    regexCharSet: '#38bdf8', // Наборы символов регулярных выражений - холодный голубой
    ...
    jsonKey2: '#7dcfff',
    jsonKey3: '#bb9af7',
    jsonKey4: '#38bdf8', // Холодный голубой
    jsonKey5: '#0db9d7',
    jsonKey6: '#73daca',
    jsonKey7: '#f7768e',
    jsonKey8: '#9ece6a',
  ...
  ansi: {
    ...
    yellow: '#7dd3fc', // Холодный голубо-желтый
    brightYellow: '#7dd3fc', // Яркий холодный голубо-желтый
    blue: '#7aa2f7', // Синий
  ...
  ui: {
    ...
    badge: {
      // Значки
      base: '#4158a6', // Базовый цвет значка
      fg: '#ffffff', // Белый текст для максимального контраста на ярком фоне значка
    },
    sash: {
      // Разделитель
    ...
    input: {
      // Поля ввода
      placeholder: '#7a85b0', // Улучшенный заполнитель для WCAG AA (было #747ca1)
      border: '#262835', // Улучшенная граница поля ввода (было #20212c)
    },
    list: {
      // Списки
      hoverBg: '#2a3047', // Улучшенный фон списка при наведении (было #24283b)
      dropBg: '#4158a6', // Фон списка при перетаскивании
    },
    ...
    tab: {
      ...
      unfocusedActiveBorder: '#2b3047', // Улучшенная граница активной вкладки без фокуса (было #24283b)
      lastPinnedBorder: '#363b54', // Граница последней закрепленной вкладки
    },
    statusItem: {
      // Состояния элементов статусбара
      hover: '#2a3047', // Улучшенное наведение на элемент статусбара (было #24283b)
    ...
    git: {
      ...
      conflicting: '#14b8a6', // Конфликтующие Git файлы - холодный teal
