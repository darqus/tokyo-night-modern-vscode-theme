...
export const calmClarityPalette: CalmClarityPalette = {
  ...
  syntax: {
    ...
    operator: '#f7768e', // Операторы (ярче для лучшей видимости)
    ...
    property: '#899ec2', // Свойства объектов (основной цвет текста для уменьшения акцента)
    ...
    warning: '#f5bf2c', // Предупреждения (ярче для лучшей видимости)
    info: '#7a9ad8', // Информационные сообщения (ярче для лучшей видимости)
    success: '#2de255', // Успешные операции (ярче для лучшей видимости)
  },
