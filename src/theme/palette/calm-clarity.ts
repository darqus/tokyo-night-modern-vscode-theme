...
export const calmClarityPalette: CalmClarityPalette = {
  ...
  syntax: {
    ...
    keyword: '#7a90b8', // Ключевые слова (нейтрально-синие)
    operator: '#8a9ab8', // Операторы (нейтральные)
    control: '#6d82a8', // Контрольные операторы (холодные)

    // Типы и классы (холодные оттенки)
    type: '#5a7aa8', // Типы данных (холодные синие)
    class: '#4d6d9a', // Классы
    interface: '#5c7db8', // Интерфейсы
    enum: '#6d8fb0', // Перечисления

    // Переменные и константы (нейтральные оттенки)
    variable: '#a8b8d8', // Переменные (нейтральные)
    parameter: '#8a9dc9', // Параметры функций (нейтральные)
    constant: '#7a92c4', // Константы (холодный сине-серый оттенок)

    // Функции и методы (холодные оттенки)
    function: '#6a9bc8', // Объявления функций (холодные)
    method: '#5c8db8', // Методы

    // Строки и числа (более теплые оттенки для контраста)
    string: '#6a9bb8', // Строки (холодный сине-голубой)
    number: '#7a94b4', // Числа (холодный сине-серый)
    boolean: '#7d95c6', // Логические значения (холодный сине-фиолетовый)

    // Свойства и объекты (холодные оттенки)
    property: '#7da0c8', // Свойства объектов
    object: '#6a9bb8', // Объекты

    // Теги и атрибуты (для разметки)
    tag: '#6a9bc8', // Теги (холодные)
    attribute: '#8a9dc9', // Атрибуты (нейтральные)

    // Ошибки и предупреждения (теплые оттенки для контраста с холодной палитрой)
    error: '#9a7a7a', // Ошибки (приглушенный красный)
    warning: '#7a8ab8', // Предупреждения (холодный сине-серый)
    info: '#6a9aa8', // Информационные сообщения (приглушенный бирюзовый)
    success: '#7a9a8a', // Успешные операции (приглушенный зеленый)
  },
