/**
 * Палитра цветов для темы Tokyo Night на основе оригинальной темы
 * Содержит все цвета из оригинальной темы tokyo-night-color-theme_original.json
 */

// Базовые цвета из оригинальной темы
export const tokyoNightColors = {
  // Цвета семантических токенов
  semantic: {
  ...
  // Цвета токенов подсветки синтаксиса
  tokenColors: {
    // Комментарии
    comment: '#51597d',
    commentDoc: '#5a638c',
    ...
    // Числа, булевы значения, константы
    numberBooleanUndefinedNull: '#ff9e64',

    // Строки
    string: '#9ece6a',
    stringConstant: '#9aa5ce',
    ...
    regex: '#b4f9f8',
    regexPunctuation: '#f7768e',
    regexCharacterClass: '#bb9af7',
    regexCharacterClassSet: '#e0af68',
    regexQuantifier: '#89ddff',
    ...
    // Markdown
    markdownPlain: '#c0caf5',
    markdownText: '#9aa5ce',
    markdownRawInline: '#bb9af7',
    markdownRawInlinePunctuation: '#4E5579',
    ...
    markdownItalic: '#c0caf5',
    markdownBold: '#c0caf5',
    markdownBoldItalic: '#c0caf5',
