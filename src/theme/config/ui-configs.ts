...
export const editorConfig: UIColorConfig = {
  ...
  groups: {
    ...
    editorBracketHighlight: {
      foreground1: (p: UniversalPalette) => p.chromatic.orange.bright,
      foreground2: (p: UniversalPalette) => p.chromatic.blue.bright,
      foreground3: (p: UniversalPalette) => p.chromatic.red.bright,
      foreground4: (p: UniversalPalette) => p.chromatic.amber.bright,
      foreground5: (p: UniversalPalette) => p.chromatic.purple.bright,
      foreground6: (p: UniversalPalette) => p.chromatic.emerald.bright,
      'unexpectedBracket.foreground': (p: UniversalPalette) =>
        p.chromatic.red.bright,
    },
    editorBracketPairGuide: {
      activeBackground1: (p: UniversalPalette) => p.chromatic.orange.main,
      activeBackground2: (p: UniversalPalette) => p.chromatic.blue.main,
      activeBackground3: (p: UniversalPalette) => p.chromatic.red.main,
      activeBackground4: (p: UniversalPalette) => p.chromatic.amber.main,
      activeBackground5: (p: UniversalPalette) => p.chromatic.purple.main,
      activeBackground6: (p: UniversalPalette) => p.chromatic.emerald.main,
    },
    editorOverviewRuler: {
      border: (p: UniversalPalette) => lightBackground(p.background.base.light),
      errorForeground: (p: UniversalPalette) => p.chromatic.red.main,
