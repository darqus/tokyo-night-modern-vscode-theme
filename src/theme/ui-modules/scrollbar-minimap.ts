...
export const scrollbarMinimapColors = {
  ...
  'scrollbarSlider.hoverBackground': palette.selectionBlueAlpha29, // Фон ползунка полосы прокрутки при наведении
  'scrollbarSlider.activeBackground': palette.selectionBlueAlpha33, // Фон активного ползунка полосы прокрутки
  ...
  'editorOverviewRuler.wordHighlightStrongForeground':
    palette.selectionBlueAlpha33, // Цвет линейки сильной подсветки слова в обзорной линейке редактора
  'minimap.findMatchHighlight': palette.purpleAlpha80, // Подсветка совпадений поиска в миникарте
  'minimap.selectionHighlight': palette.selectionBlueAlpha33, // Подсветка выделения в миникарте
}
