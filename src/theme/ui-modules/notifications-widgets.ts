...
export const notificationWidgetColors = {
 ...
 'editorSuggestWidget.background': palette.backgroundPanel,      // Фон виджета предложений редактора
  ...
  'editorSuggestWidget.selectedBackground': palette.selectionBlueAlpha33, // Фон выбранного элемента в виджете предложений
 ...
 'widget.border': palette.grayWidgetBorder,                      // Граница виджета
  ...
  'quickInputList.focusBackground': palette.selectionBlueAlpha33, // Фон списка в фокусе быстрого ввода
