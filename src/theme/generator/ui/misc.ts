...
export function generateMiscColors(): Record<string, string> {
  ...
  return {
    ...
    'debugView.stateLabelBackground': mix(bg.dark, neutral.dark, 0.1),
    ...
    'notificationCenterHeader.background': mix(bg.dark, neutral.dark, 0.1),
    'notifications.background': mix(bg.dark, neutral.dark, 0.1),
    ...
    'menubar.selectionBackground': alpha(neutral.dark, 0.2),
    'menubar.selectionBorder': lighten(mix(bg.dark, neutral.dark, 0.1), 0.04),
    'menu.foreground': fg.main,
    'menu.background': mix(bg.dark, neutral.dark, 0.1),
    'menu.selectionForeground': lighten(fg.light, 0.4),
    'menu.selectionBackground': alpha(neutral.dark, 0.4),
    'menu.separatorBackground': lighten(mix(bg.dark, neutral.dark, 0.1), 0.06),
    'menu.border': lighten(mix(bg.dark, neutral.dark, 0.1), 0.02),
