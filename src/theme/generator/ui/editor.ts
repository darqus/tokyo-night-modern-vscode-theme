...
export function generateEditorColors(): Record<string, string> {
  ...
  return {
    ...
    'editorHoverWidget.border': alpha(special.border, 0.5),
    ...
    'editorOverviewRuler.border': alpha(special.border, 0.5),
    ...
    'editorGroup.border': alpha(special.border, 0.5),
    ...
    'peekView.border': alpha(special.border, 0.5),
