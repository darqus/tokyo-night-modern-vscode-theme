...
export function generateEditorColors(): Record<string, string> {
  ...
  return {
    ...
    'editorIndentGuide.activeBackground1': mix(blue.dark, bg.main, 0.7),
    ...
    'editorHoverWidget.border': alpha(blue.light, 0.3),
    'editorBracketMatch.background': bg.main,
    'editorBracketMatch.border': lighten(bg.main, 0.02),
    'editorBracketHighlight.foreground1': blue.light,
    ...
    'editorOverviewRuler.modifiedForeground': mix(blue.main, bg.main, 0.65),
    ...
    'editorGutter.modifiedBackground': mix(blue.main, bg.main, 0.65),
    ...
    'minimapGutter.modifiedBackground': mix(blue.main, bg.main, 0.6),
    ...
    'editorWidget.background': mix(bg.main, blue.dark, 0.15),
    'editorWidget.border': alpha(blue.light, 0.3),
    'editorWidget.resizeBorder': alpha(neutral.main, 0.2),
    'editorSuggestWidget.background': bg.main,
    'editorSuggestWidget.border': alpha(blue.light, 0.3),
