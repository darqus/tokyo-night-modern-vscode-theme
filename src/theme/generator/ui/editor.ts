...
export function generateEditorColors(): Record<string, string> {
  ...
  return {
    ...
    'editorHoverWidget.background': mix(bg.main, blue.primary, 0.15),
    ...
    'editorBracketHighlight.foreground4': brackets.yellow,
    'editorBracketHighlight.foreground5': brackets.teal,
    'editorBracketHighlight.foreground6': brackets.green,
    ...
    'editorBracketPairGuide.activeBackground4': brackets.yellow,
    'editorBracketPairGuide.activeBackground5': brackets.teal,
    'editorBracketPairGuide.activeBackground6': brackets.green,
