...
export function generateEditorColors(): Record<string, string> {
  ...
  return {
    ...
    'editorHoverWidget.border': bg.lighter,
    ...
    'editorOverviewRuler.border': bg.lighter,
