...
export function generateCodeTokens(): TokenColor[] {
  const { red, pink, orange, blue, cyan, purple, yellow, green, fg, teal } = palette;
  ...
  return [
    ...
    },
    {
      ...
      scope: ['punctuation.definition.tag', 'text.html.php meta.embedded.block.html meta.tag.metadata.script.end.html punctuation.definition.tag.begin.html text.html.basic'],
    ...
    {
      name: 'Variables',
      scope: ['variable', 'support.variable', 'string constant.other.placeholder', 'variable.parameter.handlebars', 'variable.other.object', 'meta.fstring', 'meta.function-call meta.function-call.arguments', 'meta.embedded.inline.phpx constant.other.php'],
