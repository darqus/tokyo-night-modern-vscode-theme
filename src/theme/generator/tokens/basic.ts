...
export function generateBasicTokens(): TokenColor[] {
  const { orange, green, purple, cyan, red, yellow, blue, special, fg } = palette;
  ...
  return [
    ...
    },
    {
      ...
      scope: ['keyword.control.smarty', 'keyword.control.twig', 'support.constant.handlebars keyword.control', 'keyword.operator.comparison.twig', 'keyword.blade', 'entity.name.function.blade', 'meta.tag.blade keyword.other.type.php'],
