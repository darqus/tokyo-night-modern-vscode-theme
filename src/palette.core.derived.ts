...
export const bgHover = lightenToward(interfaceColors.editorBg, basePalette.white, 0.1)
export const bgActive = lightenToward(interfaceColors.editorBg, basePalette.blue, 0.07)
export const bgDrop = darkenToward(interfaceColors.editorBg, basePalette.black, 0.12)
...
export const textPrimary = darkenToward(basePalette.black, basePalette.white, 0.65)
...
export const textGray600 = darkenToward(basePalette.gray, basePalette.black, 0.2)
...
export const textPlaceholder = mix(interfaceColors.editorFg, basePalette.gray, 0.5)
...
export const brandButtonHover = mix(interfaceColors.editorBg, basePalette.blue, 0.3)
