...
Пример генерации расширенной палитры можно найти в файле `src/theme/palette/generated.ts`.

Файл `src/theme/palette/generated.ts` содержит алиасы для `basePalette`, что позволяет использовать упрощенные имена цветов в теме.
