...
### 1. 🎨 Цветовая схема и контрастность
...
comment: '#6b7499', // вместо #444b6a
commentDoc: '#545c7e', // оставить как есть для документации
inactive: '#666d94', // вместо #545c7e для лучшей видимости
```

### 2. 🔤 Синтаксическое выделение

#### Проблема: Несбалансированное использование цветов
- **Чрезмерное использование голубых оттенков** (`#7dcfff`, `#0db9d7`, `#89ddff`) для разных типов токенов
- **Недостаточное разнообразие** для различных контекстов переменных
- **Операторы** (`#89ddff`) могут сливаться с другими элементами

#### Рекомендация:
```typescript
// Более сбалансированная цветовая схема
operator: '#c0caf5', // использовать основной цвет текста
importExport: '#bb9af7', // использовать магента для ключевых слов import/export
templateKeyword: '#73daca', // более отличимый оттенок
```
...
hover: '#24283b', // темнее для лучшего контраста
active: '#2a3041', // еще темнее для активного состояния
focusBorder: '#7dcfff66', // более яркий border для фокуса
```

### 4. ⚡ Семантические токены
...
#### Рекомендация:
```typescript
// Более контрастные цвета скобок
editorBracketHighlight: {
  foreground1: '#7aa2f7', // синий
  foreground2: '#ff9e64', // оранжевый (вместо cyan)
  foreground3: '#9ece6a', // зеленый (вместо magenta)
